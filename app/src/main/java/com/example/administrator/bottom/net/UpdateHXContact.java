...
public class UpdateHXContact {
    public UpdateHXContact(HXContact hxContact, final UpdateHXContact.SuccessCallback successCallback, final UpdateHXContact.FailCallback failCallback) {
        ...
        }, Config.KEY_ACTION, Config.ACTION_UPDATE_HX_CONTACT, Config.KEY_HX_USERNAME, hxContact.getUsername(), Config.KEY_PORTRAIT, hxContact.getPortrait(), Config.KEY_HX_NICKNAME, hxContact.getNickname());
