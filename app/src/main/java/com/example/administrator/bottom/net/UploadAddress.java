...
public class UploadAddress {
    public UploadAddress(String phone, String school, String area, String building, String room, final SuccessCallback successCallback, final FailCallback failCallback) {
        ...
        }, Config.KEY_ACTION, Config.ACTION_UPLOAD_ADDRESS, Config.KEY_ADDRESS_SCHOOL, school, Config.KEY_ADDRESS_AREA, area, Config.KEY_ADDRESS_BUILDING, building, Config.KEY_ADDRESS_ROOM, room, Config.KEY_PHONE_NUM, phone);
    }
