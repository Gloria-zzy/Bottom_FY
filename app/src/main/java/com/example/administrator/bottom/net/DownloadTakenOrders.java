...
public class DownloadTakenOrders {
    public DownloadTakenOrders(String taker, final SuccessCallback successCallback, final FailCallback failCallback) {
        ...
        }, Config.KEY_ACTION, Config.ACTION_DOWNLOAD_TAKEN_ORDERS, Config.KEY_TAKER, taker);
    }
