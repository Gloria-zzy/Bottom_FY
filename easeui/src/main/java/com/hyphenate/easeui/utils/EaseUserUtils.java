...
//                Glide.with(context).load(avatarResId).into(imageView);
                Log.i("EaseUserUtils", "setUserAvatar" + user.getAvatar());
...
//            Glide.with(context).load("http://101.132.190.102:8080/TestServer/img/crop_20180222183217.jpg").into(imageView);
        } else {
